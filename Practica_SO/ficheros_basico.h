...
// Constantes para determinar el rango de los punteros
...
/*
int liberar_bloques_recursivo(unsigned int *nBL, int nRangoBL, unsigned int ptr, unsigned int nivel_punteros, struct inodo *inodo,
    int *eof, int ultimoBL, int *bloqueLiberado);
*/